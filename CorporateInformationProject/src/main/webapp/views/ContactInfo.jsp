...
<body style="background-color: black">
   ...
   <div id="div-1" class="mb-3"> 
	...
	<form:form action="saveContact" modelAttribute="contact" method="POST">
		...
		<h2>Welcome To Corporate Information Dictionary</h2>
		<p>
		...
		<table id="customers">
			...
			<tr>
				...
				<td><form:input path="contactNumber" placeholder="Enter Number" /></td>
			</tr>
		...
		<a href="viewContact">ViewAllCorporateInformation</a>
